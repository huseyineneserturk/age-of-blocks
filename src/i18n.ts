...
const UI: Record<Lang, Record<string, string>> = {
  tr: {
    ...
    // Help tooltip
    'help.title': 'Kısayollar & Kontroller',
    'help.selectLabel': 'Sol Tık / Sürükle:',
    'help.selectText': 'Seçim Yap',
    'help.moveLabel': 'Sağ Tık:',
    'help.moveText': 'Yürüt / Saldır',
    'help.attackLabel': 'A + Sol Tık:',
    'help.attackText': 'Saldırı Hareketi',
    'help.cameraLabel': 'WASD / Yön Tuşları:',
    'help.cameraText': 'Kamerayı Kaydır',
    'help.zoomLabel': 'Tekerlek:',
    'help.zoomText': 'Yakınlaştır / Uzaklaştır',
    'help.escLabel': 'ESC:',
    'help.escText': 'Seçimi İptal Et / Menü',
    'help.hotkeysLabel': 'Hızlı İnşa (1-9 / Q-W):',
    'help.hotkeysText': 'Köylü seçiliyken binaları yerleştirir',
    'help.armyLabel': 'Grup Seçimi (1-4):',
    'help.armyText': 'Asker gruplarını hızlıca seçer',
    'help.cycleVillagerLabel': '" Tuşu:',
    'help.cycleVillagerText': 'Köylüler arasında geçiş yapar',
  },
  en: {
    // Menu
    ...
    // Help tooltip
    'help.title': 'Hotkeys & Controls',
    'help.selectLabel': 'Left Click / Drag:',
    'help.selectText': 'Select Units',
    'help.moveLabel': 'Right Click:',
    'help.moveText': 'Move / Attack',
    'help.attackLabel': 'A + Left Click:',
    'help.attackText': 'Attack Move',
    'help.cameraLabel': 'WASD / Arrows:',
    'help.cameraText': 'Pan Camera',
    'help.zoomLabel': 'Scroll Wheel:',
    'help.zoomText': 'Zoom In / Out',
    'help.escLabel': 'ESC:',
    'help.escText': 'Cancel Selection / Menu',
    'help.hotkeysLabel': 'Quick Build (1-9 / Q-W):',
    'help.hotkeysText': 'Place buildings when a villager is selected',
    'help.armyLabel': 'Army Groups (1-4):',
    'help.armyText': 'Select unit groups when soldiers are selected',
    'help.cycleVillagerLabel': '" Key:',
    'help.cycleVillagerText': 'Cycle through your villagers',
  },
};
